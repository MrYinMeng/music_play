...
u32 LCD_ReadPoint(u16 x,u16 y)
{
	...
	LCD_SetCursor(x,y);
    if (lcddev.id == 0X5310)                        //其他IC(9341/5310/1963/7789)发送读GRAM指令
    {
        LCD_WR_REG(0X2E);
    }
...
{					   
    if (lcddev.id == 0X5310)                        //9341/5310/1963/7789 等发送开启显示指令
    {
...
{	   
    if (lcddev.id == 0X5310)                        //9341/5310/1963/7789 等发送关闭显示指令
    {
...
{
    if (lcddev.id == 0X5310)     //9341/5310/7789等设置坐标
    {
...
void LCD_Scan_Dir(u8 dir)
{
    ...
    if (lcddev.id == 0X5310)   //1963不做坐标处理
    {
        if (regval & 0X20)
        {
...
void LCD_Display_Dir(u8 dir)
{
    ...
    if (dir == 0)           //竖屏
    {
        ...
        if (lcddev.id == 0X5310)                        //其他IC, 包括: 9341 / 5310 / 7789等IC
        {
            lcddev.wramcmd = 0X2C;
            lcddev.setxcmd = 0X2A;
            lcddev.setycmd = 0X2B;
...
void LCD_Set_Window(u16 sx, u16 sy, u16 width, u16 height)
{
    ...
    if (lcddev.id == 0X5310)       //9341/5310/7789/1963横屏 等 设置窗口
    {
        LCD_WR_REG(lcddev.setxcmd);
        LCD_WR_DATA(sx >> 8);
        LCD_WR_DATA(sx & 0XFF);
